...
import ColorfulHeading from './ColorfulHeading';
...
export default function Footer() {
  return (
    <footer className="border-t border-pink-100 bg-pink-100">
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 overflow-hidden">
        <ColorfulHeading text="Make your life more colorful!" />
      </div>

      <div className="mx-auto max-w-7xl px-6 py-10 border-t border-pink-200/60">
        {/* Mobile */}
